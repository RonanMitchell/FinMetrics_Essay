...
Yield_Plotter(Data = CPI,
              Vec = Dev_Count, 
              y = Inflation,
              "Developed Nations Inflation")

Yield_Plotter(Data = CPI,
              Vec = Developing_vec, 
              y = Inflation,
              "Developing Nations Inflation")
...
M1 <- Map_Data_foo(Bonds10yr, BondYield_10)
M2 <- Map_Data_foo(Bonds2yr, BondYield_2)
...
create_map(M1, "Average Bond Yield (10-Year)")
