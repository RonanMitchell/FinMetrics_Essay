...
output: 
 md_document:
   variant: gfm
---
This is the README for an R project. The purpose of this README is to guide the reader through the programming decisions I made when plotting bond yields calculating yield spreads in order to answer the following question: 
